...
<html>
    ...
    <body>
	<div class="navbar">
		  <div class="usertype" onclick="window.location.href='login.php'">Return to login</div>
	</div>
			...
			if (isset($_POST["submit"])) {
				...
				if(count($errors)>0) {
					...
					if($prepare) {
						...
						echo "<div regClass='registersuccess'>You are registered successfully.</div>";
					}else{
				...
				<div class = "tab" id="map"> 
					<script>
						...
						function createCivilian(e) {
							...
							//remove the click event listener after the first click to not make infinite civilians
